...
<body>
	...
	<div class = "container">
		...
		@if(count($templates) > 0)
				...
				<table class = "table">
					...
					@foreach($templates as $template)
						<tr data-id = "{{$template->id}}">
							<td><a href = "{{ url('/prod_config/templates/'.$template->id) }}" class = "update" data-toggle = "tooltip" data-placement = "top"
			...
			{!! Form::open(['url' => url('/prod_config/templates/id'), 'method' => 'delete', 'id' => 'delete-template']) !!}
			{!! Form::close() !!}
		@else
			<div class = "col-xs-12">
		...
		<div class = "col-xs-12">
			...
			{!! Form::open(['url' => url('prod_config/templates'), 'method' => 'post', 'class' => 'form-horizontal']) !!}
