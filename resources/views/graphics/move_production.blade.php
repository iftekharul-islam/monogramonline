	...
	@include('includes.header_menu')
		<div class = "container" style="width:95%;">
			<ol class = "breadcrumb">
				...
				<li class = "active">Move to Production</li>
			</ol>
			...
			<div class = "col-md-12">
				<div class = "col-xs-12">
					<div class="form-group">
					 {!! Form::open(['name' => 'barcode_form', 'url' => '/move_to_production/show_batch', 'method' => 'post', 'id' => 'barcode_form']) !!}          
							<div class = "form-group col-xs-3">
								{!! Form::text('scan_batches', '', ['id'=>'barcode', 'class' => 'form-control', 'placeholder' => 'Enter Batch']) !!}
							</div>
							<div class = "form-group col-xs-2">
								{!! Form::submit('Show Batch', ['id'=>'move_button', 'class' => 'btn btn-primary btn-sm form-control']) !!}
							</div>
						{!! Form::close() !!}
						
						 <div class = "form-group col-xs-2"></div>
						{!! Form::open(['name' => 'store_form','url' => '/move_to_production', 'method' => 'get', 'id' => 'store_form']) !!}
							 <div class = "form-group col-xs-3">
