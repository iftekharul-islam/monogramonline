...
if ($shipment->getShipmentUSPSEndorsement()) {
	$shipmentNode->appendChild($xml->createElement('USPSEndorsement', $shipment->getShipmentUSPSEndorsement()));
// 	$shipmentNode->appendChild($xml->createElement('CostCenter', '0000'));
// 	$shipmentNode->appendChild($xml->createElement('PackageID', '1'));
}

if ($shipment->getCostCenter()) {
	$shipmentNode->appendChild($xml->createElement('CostCenter',  $shipment->getCostCenter()));
}
