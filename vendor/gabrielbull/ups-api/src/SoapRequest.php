...
class SoapRequest implements RequestInterface, LoggerAwareInterface
{
    ...
    public function request($access, $request, $endpointurl, $operation = null, $wsdl = null)
    {
	    ...
	    $this->logger->info('SOAP Request Header:', $client->__getLastRequestHeaders());
	    $this->logger->info('SOAP Request:', $client->__getLastRequest());
	    
	    $this->logger->info('SOAP Response Header:', $client->__getLastReponseHeaders());
	    $this->logger->info('SOAP Response:', $client->__getLastResponse());
