...
class Package implements NodeInterface
{
    ...
    public function __construct($attributes = null)
    {
        ...
        $this->setReferenceNumber1(new ReferenceNumber());
	$this->setReferenceNumber2(new ReferenceNumber());
        ...
        if (null !== $attributes) {
            ...
            if (isset($attributes->ReferenceNumber)) {
                $this->setReferenceNumber1(new ReferenceNumber($attributes->ReferenceNumber));
            }
	    if (isset($attributes->ReferenceNumber)) {
                $this->setReferenceNumber2(new ReferenceNumber($attributes->ReferenceNumber));
            }
    ...
    public function toNode(DOMDocument $document = null)
    {
        ...
        if ($this->getReferenceNumber1()
            && !is_null($this->getReferenceNumber1()->getCode())
            && !is_null($this->getReferenceNumber1()->getValue())
        ) {
            $packageNode->appendChild($this->getReferenceNumber1()->toNode($document));
        }
     ...
     * @return Package
     */
    public function setReferenceNumber1(ReferenceNumber $referenceNumber)
    {
        $this->referenceNumber1 = $referenceNumber;

        return $this;
    }

    public function removeReferenceNumber1()
    {
        $this->referenceNumber1 = null;
    }
