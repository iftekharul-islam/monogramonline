...
class Shipment
{
     ...
     * @var string
     */
    private $shipmentUSPSEndorsement;
     ...
     * @return string
     */
    public function getShipmentUSPSEndorsement()
    {
        return $this->shipmentUSPSEndorsement;
    }

    /**
     * @param string $shipmentUSPSEndorsement
     * @return Shipment
     */
    public function setShipmentUSPSEndorsement($shipmentUSPSEndorsement)
    {
        $this->shipmentUSPSEndorsement = $shipmentUSPSEndorsement;
    ...
    /**
     * @param boolean $MILabelCN22Indicator
     * @return Shipment
     */
