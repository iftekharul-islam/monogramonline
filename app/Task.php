...
class Task extends Model
{
    ...
    public static function new($text, $user_id = null, $model = null, $id = null, 
                                $close_event = null, $previous_task = null, $attachment = null, $due_date = null)
    {
      $task = new Task;
    ...
    {
      return $this->hasMany('App\TaskNote', 'task_id', 'id');
    }
    ...
    public static function getTables() {
      ...
      return [  'App\Order'    => 'Order', 
                ...
                'App\Product'  => 'Product',
                // 'App\Item'     => 'Item',
                'App\Option'   => 'Child SKU',
                'App\Purchase' => 'Purchase Order',
