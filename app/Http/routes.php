...
get("zakeke_switch_type", 'CustomController@zakeke_switch_type'); //invalid
...
//        get('getDhlInternationalManifest','DhlManifestController@getDhlInternationalManifest');
        ...
        resource('manufactures', 'ManufactureController');
        get('manufacture_control/{id}', 'ManufactureController@access');
        post('manufacture/permission/update/{id}', 'ManufactureController@accessUpdate');
