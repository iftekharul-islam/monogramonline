...
class ItemController extends Controller
{
    ...
    public function indexGraphic(Request $request)
    {
        ...
        #return $items;
        return view('items.index_graphic',
            compact('items', 'orders', 'emptyStationsCount', 'search_in', 'request', 'unassigned', 'item_sum',
    ...
    public function getBatch(Request $request)
    {
        ...
        $batch_routes = Batching::createAbleBatches($backorder, true, $start_date, $end_date, $search_for_first,
            $search_in_first, $store, $section);
                    ...
                    foreach ($order->items as $item) {
                        ...
                        if($item->item_status == 'production' || $item->item_status == 'rejected' || $item->item_status == 'wap') {
                            ...
                            $item_status[$item->id] = [
                                ...
                                'Shipped ' . $item->shipinfo->mail_class . ' - ' . $track
                            ];
...
//            $item_thumb = 'https://' . $this->domain . '/assets/images/template_thumbs/axe-co-2928288789-1798214.jpg';
            ...
            if($headers && strpos($headers[0], '200') !== false) {
                ...
                try {
                    ...
                    echo $thumb;
                    ImageHelper::createThumb($options['Custom_EPS_download_link'], 0,
